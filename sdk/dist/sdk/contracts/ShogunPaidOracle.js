...
export class ShogunPaidOracle extends BaseContract {
     ...
     */
    async updatePrice(packet, paymentWei = 0n) {
     ...
     */
    async updateAndGetPrice(packet, paymentWei = 0n) {
